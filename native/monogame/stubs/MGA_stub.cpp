...
// Stub audio implementation for OpenXR platforms where FAudio is not yet available.
// All functions are no-ops that return safe defaults.

#include "../include/api_common.h"
#include "../include/api_enums.h"
#include "../include/api_structs.h"

struct MGA_System {};
struct MGA_Buffer {};
struct MGA_Voice {};

MG_EXPORT MGA_System* MGA_System_Create() { return nullptr; }
MG_EXPORT void MGA_System_Destroy(MGA_System* system) {}
MG_EXPORT mgint MGA_System_GetMaxInstances() { return 0; }
MG_EXPORT void MGA_System_SetReverbSettings(MGA_System* system, ReverbSettings& settings) {}

MG_EXPORT MGA_Buffer* MGA_Buffer_Create(MGA_System* system) { return nullptr; }
...
MG_EXPORT mgulong MGA_Buffer_GetDuration(MGA_Buffer* buffer) { return 0; }

MG_EXPORT MGA_Voice* MGA_Voice_Create(MGA_System* system, mgint sampleRate, mgint channels) { return nullptr; }
MG_EXPORT void MGA_Voice_Destroy(MGA_Voice* voice) {}
MG_EXPORT mgint MGA_Voice_GetBufferCount(MGA_Voice* voice) { return 0; }
MG_EXPORT mgint MGA_Voice_GetFinishedBufferCount(MGA_Voice* voice) { return 0; }
...
MG_EXPORT MGSoundState MGA_Voice_GetState(MGA_Voice* voice) { return MGSoundState::Stopped; }
MG_EXPORT mgulong MGA_Voice_GetPosition(MGA_Voice* voice) { return 0; }
