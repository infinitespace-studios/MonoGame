...
public sealed class BuildNativeDependenciesTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        var faudioSrcDir = "native/monogame/external/faudio";
        var faudioBuildDir = System.IO.Path.Combine(faudioSrcDir, "build");
        ...
        faudioConfigureArgs.Append("-DBUILD_SDL3=OFF -DBUILD_SHARED_LIBS=OFF");
